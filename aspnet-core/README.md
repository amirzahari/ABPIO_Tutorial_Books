...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c87ee1c4-2410-4d2e-837e-7756fe981a5f
```

> `c87ee1c4-2410-4d2e-837e-7756fe981a5f` is the password of the certificate, you can change it to any password you want.
